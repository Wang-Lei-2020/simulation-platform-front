...
<!--    </el-breadcrumb>-->
    ...
    <el-tabs v-model="headTapActiveName" type="card" style="margin-top: 20px">
      ...
      <el-tab-pane label="课程作业" name="second">
            <div class="courseList" style="margin-top: 20px">
              <el-table :data="myCourseList" border>
                <el-table-column label="作业标题" align="center" prop="courseId" width="180px" />
                <el-table-column label="发布人" align="center" prop="courseName" width="140px" />
                <el-table-column label="提交截止时间" align="center" prop="introduction" width="180px" />
                <el-table-column label="作业资源下载" align="center" prop="courseTeacher" width="190px" />
                <el-table-column label="提交作业" align="center" prop="courseCredit" width="170px" />
                <el-table-column label="我的成绩" align="center" prop="capacity" width="190px" />

                <el-table-column label="操作" align="center" width="195" class-name="small-padding fixed-width">
                  <template>
                    <el-button size="mini" type="text" icon="el-icon-tickets">练习</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
      </el-tab-pane>
      <el-tab-pane label="课程考核" name="third">
...
export default {
  name: "CourseStudy",
  components:{CodeCompile, CoursePractice},
  data(){
    return{
      headTapActiveName: 'first',
      activeName:'tab0',
      tabPosition:'right',
      scroll: '',
      navList: [],
